...
const RemoveCard = props => {
  ...
  return (
    <div>
      <Button size="small" component="label" onClick={handleOpen} variant="outlined" color="error" >Remove Card</Button>
      <Modal
      ...
      >
        <Fade in={open}>
          ...
          <Typography variant="body1" gutterBottom>
			  You are removing {name}, please select how many cards to remove from this deck.
      </Typography>
				<br></br>
		<TextField 
			type="number"
